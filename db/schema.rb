...
ActiveRecord::Schema.define(version: 20150727232744) do
  ...
  create_table "cover_images", force: true do |t|
    t.string   "image_desktop_file_name"
    t.string   "image_desktop_content_type"
    t.integer  "image_desktop_file_size"
    t.datetime "image_desktop_updated_at"
  ...
  create_table "gemgento_bundle_items", force: true do |t|
    t.integer  "bundle_option_id"
    t.integer  "product_id"
    t.integer  "magento_id"
  ...
  create_table "gemgento_bundle_options", force: true do |t|
    t.integer  "product_id"
    t.integer  "magento_id"
    t.string   "name"
  ...
  create_table "gemgento_line_item_options", force: true do |t|
  ...
  create_table "gemgento_price_tiers", force: true do |t|
    t.integer "product_id"
    t.integer "store_id"
    t.integer "user_group_id"
  ...
  create_table "gemgento_wishlist_items", force: true do |t|
    t.integer  "product_id"
    t.integer  "user_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "journalimages", force: true do |t|
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  add_index "journalimages", ["post_id"], name: "index_journalimages_on_post_id", using: :btree

  create_table "lookbook_images", force: true do |t|
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string   "lookbook_image_file_name"
    t.string   "lookbook_image_content_type"
    t.integer  "lookbook_image_file_size"
    t.datetime "lookbook_image_updated_at"
    t.integer  "collection_id"
    t.text     "text_field_1"
    t.text     "text_field_2"
    t.string   "title"
    t.string   "title_1"
    t.string   "lookbook_image_1_file_name"
    t.string   "lookbook_image_1_content_type"
    t.integer  "lookbook_image_1_file_size"
    t.datetime "lookbook_image_1_updated_at"
    t.string   "product_id"
    t.string   "product_id_1"
    t.string   "gemgento_product_id"
    t.string   "gemgento_product_id_1"
  end
  ...
  create_table "posts", force: true do |t|
    ...
    t.string   "featured_image_vert_file_name"
    t.string   "featured_image_vert_content_type"
    t.integer  "featured_image_vert_file_size"
    t.datetime "featured_image_vert_updated_at"
    t.string   "author"
  end
